...
5. Exit \n''')	
	...
	if(opt==1):
		...
		print(Fore.RED+"Wrong input provided!!!".center(width))
...
if __name__=="__main__":	
	...
	if((uname==luser) and (upass==lpass)):
		print("Welcome to locker\n".center(width))
		menu()				
	else:
		print(Fore.RED+"Incorrect Credentials!!!".center(width))
